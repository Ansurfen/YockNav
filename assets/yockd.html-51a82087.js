import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-62237bf4.js";const p={},t=e(`<p>Yockd 声明yock守护进程的配置，主要用于后台启动和对话Peer建立P2P或中心化集群。</p><h2 id="自启动" tabindex="-1"><a class="header-anchor" href="#自启动" aria-hidden="true">#</a> 自启动</h2><div class="language-lua line-numbers-mode" data-ext="lua"><pre class="language-lua"><code><span class="token function">option</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
