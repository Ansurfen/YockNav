...
heroText: Yock
tagline: Yock is a solution of cross platform to compose distributed build stream.
actions:
  - text: GET START 💡
    link: ./guide/
    type: primary
...
highlights:
  - header: Easy to install
    ...
    highlights:
      - title: You can download the binary version <a href="https://github.com/Ansurfen/yock/releases" target="_blank">here</a>.
      - title: Run <code>yock run install.lua</code> in yock's root to init yock environment after uncompress.
  ...
  - header: Features
    ...
    features:
      - title: native GNU command
        icon: comment-dots
        details: insteads of batch and shell, and writes once and runs anywhere
        link: ./guide/gnu/

      - title: coroutine
        icon: circle-info
        details: native goroutine, executes with fast and effective
        link: ./guide/concurrency/

      - title: pipeline
        icon: lock
        details: effective composes different tasks based on job
        link: ./guide/pipeline/
      ...
      - title: ypm
        icon: copy
        details: built-in package manager, and is beneficial for distributing and instaling module.
        link: ./ypm/
...
copyright: false
footer: Theme by <a href="https://theme-hope.vuejs.press/" target="_blank">VuePress Theme Hope</a> | MIT Licensed, Copyright © 2023-present The Yock Authors
---
<!-- 
